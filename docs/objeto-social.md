...
**ARTÍCULO [N] — OBJETO SOCIAL.** La compañía tendrá por objeto:

### a) Software y servicios informáticos

El diseño, desarrollo, programación, implementación, licenciamiento, comercialización,
distribución, mantenimiento, actualización y soporte técnico de programas y sistemas
informáticos de gestión administrativa, contable, financiera, fiscal, tributaria, de
nómina, de inventario y de facturación digital; la prestación de dichos sistemas bajo
la modalidad de servicio por suscripción (software como servicio); el diseño y
desarrollo de sitios web, tiendas en línea y aplicaciones móviles.

### b) Automatización e inteligencia artificial

El diseño, desarrollo e implementación de soluciones de automatización de procesos
administrativos y de agentes de inteligencia artificial aplicados a la gestión
empresarial; la integración de dichas soluciones con los sistemas del cliente y con
plataformas de mensajería, correo y terceros.

### c) Integraciones

La integración e interconexión de sistemas propios y de terceros mediante interfaces
de programación de aplicaciones (API), incluyendo la conexión con instituciones
...
de equipos, dispositivos, periféricos, repuestos, accesorios y consumibles
tecnológicos, entre ellos y sin que la enumeración sea limitativa:

- **Equipos fiscales y de punto de venta:** impresoras fiscales, impresoras de
  tickets, gavetas de dinero, visores de cliente, terminales de punto de venta.
- **Equipos de captura de datos:** lectores de códigos de barras y QR, balanzas
  electrónicas con impresión de etiquetas, etiquetadoras, lectores biométricos y
  equipos de control de acceso y de asistencia.
- **Infraestructura y contingencia:** servidores, equipos de almacenamiento y
  respaldo de datos, equipos de red y conectividad, sistemas de alimentación
  ininterrumpida y respaldo eléctrico.
...
## Puntos que debe revisar el abogado

**1. Distribución de máquinas fiscales.** Ese ramo se rige por la Providencia
...
**3. Arrendamiento y comodato de equipos.** Se incluyen a propósito: entregar una
impresora fiscal en préstamo junto con la suscripción es un modelo común, y un objeto
que solo diga "venta" no lo cubriría.
