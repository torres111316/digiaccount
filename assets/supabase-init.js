...
(function () {
  ...
  // === OCR del certificado RIF (Agente IA · alta de empresa) ===
  // Recibe el certificado RIF del SENIAT (PDF o foto) y devuelve los datos:
  // { ok, rif, razon_social, domicilio, fecha_vencimiento, condicion, tipo, confianza }
  const RIF_URL = 'https://n8n.digiaccount.io/webhook/ocr-rif';
  window.__ocrRif = function (file) {
    return new Promise(function (resolve) {
      try {
