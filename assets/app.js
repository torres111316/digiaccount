...
(function () {
  ...
  /* CONTABILIDAD vive ahora en assets/contabilidad.js — se saco de aqui para que
  ...
  /* INVENTARIO vive ahora en assets/inventario.js — se saco de aqui para que
     este archivo deje de crecer. Lo que publica en `window.*` se sigue
     usando igual desde los demas modulos. */
...
/* El siguiente de una serie, copiando el formato del último usado.
  ...
  /* TERCEROS vive ahora en assets/terceros.js — se saco de aqui para que
     este archivo deje de crecer. Lo que publica en `window.*` se sigue
     usando igual desde los demas modulos. */
